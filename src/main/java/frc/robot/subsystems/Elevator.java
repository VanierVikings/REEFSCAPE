...
public class Elevator extends SubsystemBase {
    ...
    //         elevatorClosedLoopController.setReference(getElevatorHeight(), ControlType.kMAXMotionPositionControl);
    //         elevatorClosedLoopController.setReference(getAngle(), ControlType.kMAXMotionPositionControl);
    ...
    //         pivotClosedLoopController.setReference(getElevatorHeight(), ControlType.kMAXMotionPositionControl);
    //         pivotClosedLoopController.setReference(getAngle(), ControlType.kMAXMotionPositionControl);
    //         }// Kill code, don't know if works
    // }
    ...
    //         .until(() -> checkElevatorHeight(elevatorCurrentTarget, 0.01)); // tolerance will be tuned or whatever later
