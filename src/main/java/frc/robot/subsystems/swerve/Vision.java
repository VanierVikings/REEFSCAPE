//Vision v1.10 (REQUIRES LLOS 2024.9.1 OR LATER)
...
import frc.robot.subsystems.swerve.Vision.LimelightResults;
import frc.robot.subsystems.swerve.Vision.PoseEstimate;
...
/**
 * Vision provides static methods and classes for interfacing with Limelight vision cameras in FRC.
...
public class Vision {
    ...
    private static PoseEstimate getBotPoseEstimate(String limelightName, String entryName, boolean isMegaTag2) {
        DoubleArrayEntry poseEntry = Vision.getLimelightDoubleArrayEntry(limelightName, entryName);
    ...
    public static RawFiducial[] getRawFiducials(String limelightName) {
        var entry = Vision.getLimelightNTTableEntry(limelightName, "rawfiducials");
    ...
    public static RawDetection[] getRawDetections(String limelightName) {
        var entry = Vision.getLimelightNTTableEntry(limelightName, "rawdetections");
    ...
    public static LimelightResults getLatestResults(String limelightName) {
        ...
        Vision.LimelightResults results = new Vision.LimelightResults();
        if (mapper == null) {
