...
public class LED {
  ...
  public static enum States {
    SetupDone(setColor((int)(Color.kAliceBlue.red), (int)(Color.kAliceBlue.green), (int)(Color.kAliceBlue.blue))), // set in robotPeriodic
    Disabled(pulse(0.25, setColor((int)(Color.kDarkRed.red), (int)(Color.kDarkRed.green), (int)(Color.kDarkRed.blue)))),
    ShooterSpeedReached(pulse(0.25, setColor((int)(Color.kLimeGreen.red), (int)(Color.kLimeGreen.green), (int)(Color.kLimeGreen.blue)))),
    ShooterEnabled(setColor((int)(Color.kLimeGreen.red), (int)(Color.kLimeGreen.green), (int)(Color.kLimeGreen.blue))),
    HasNote(setColor((int)(Color.kAliceBlue.red), (int)(Color.kAliceBlue.green), (int)(Color.kAliceBlue.blue))),
    IntakeNote(pulse(0.25, setColor((int)(Color.kAliceBlue.red), (int)(Color.kAliceBlue.green), (int)(Color.kAliceBlue.blue)))),
    Default(setColor((int)(Color.kBlack.red), (int)(Color.kBlack.green), (int)(Color.kBlack.blue)));
